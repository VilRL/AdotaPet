...
public class FindOwnerByIdHandler implements Handler<String, Optional<Owner>> {
    ...
    public Optional<Owner> execute(String body) {
        try {
            ...
            Logger.error("Error finding owner by id", e);
            throw new RuntimeException("Error finding owner by id: " + e.getMessage(), e);
        }
    }
